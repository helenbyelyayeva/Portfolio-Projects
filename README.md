...
- [x] SQL & Looker  
    - Ad Analysis - This repository contains queries to analyze ad campaign performance data from Facebook and Google Ads.
...
- [x] SQL & Tableau
    - Revenue Metrics SQL & Dashboard - This repository contains queries to create views for a dashboard that enables hypothetical product managers to analyze revenue metrics, track changes in revenue dynamics, and conduct high-level analysis of the factors driving these changes.
